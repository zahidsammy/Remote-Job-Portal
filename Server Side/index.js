...
//  username(${process.env.DB_USER}) and password(${process.env.DB_PASS}) here

const uri = `mongodb+srv://zahidsammy95:${process.env.DB_PASS}@job-portal.kpz9fyl.mongodb.net/?retryWrites=true&w=majority`
