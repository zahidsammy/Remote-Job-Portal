...
const CreateJob = () => {
        // State to manage selected options for skills
    const [selectedOption, setSelectedOption] = useState(null);
  
    
    // React Hook Form methods for handling form state and submission
    const {
      register,
      handleSubmit,
      formState: { errors },
    ...
    const onSubmit = (data) => {
      ...
      data.skills = selectedOption;
        ...
        // Make a POST request to the server with job data
  ...
  // Options for the skills selection dropdown
    const options = [
      ...
      <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        ...
        <div className="bg-[#FAFAFA] py-10 px-4 lg:px-16">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <input
              type="submit"
              className="block mt-12 bg-pink text-white font-semibold px-8 py-2 rounded-sm cursor-pointer"
            />
          </form>
        </div>
      </div>
