      ...
      <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        ...
        <div className="mt-10">
          ...
          <div className="my-4 space-y-2">
            ...
            <button className="bg-indigo-500 px-6 py-1 text-white rounded-sm ms-2" onClick={handleJobApply}>
              Apply Now
            </button>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-12 mt-12">
            ...
            <div className="md:w-1/3">
              ...
              <p className="text-primary/90">
                ...
                <br />
                <br />
                Were passionate about web design and development and are focused
